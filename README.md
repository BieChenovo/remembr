...
The implemented v3 controller-interleaved behavior and v4 unified top-1, cross-modal state, duplicate-replanning contract are documented in the [Q-RAG retrieval fix specification](./docs/QRAG_RETRIEVAL_FIX_SPEC.md).
